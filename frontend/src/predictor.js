...
// }
//} else {
// wasmBinaryFile = new URL("predictor.wasm", import.meta.url).toString();
//}
...
var _predict = Module["_predict"] = function() {
 return (_predict = Module["_predict"] = Module["asm"]["B"]).apply(null, arguments);
};
