...
// template <> struct select_npy_type<int8_t> { const static NPY_TYPES type = NPY_int8; };
// template <> struct select_npy_type<int16_t> { const static NPY_TYPES type = NPY_USHORT; };
// template <> struct select_npy_type<int32_t> { const static NPY_TYPES type = NPY_ULONG; };
// template <> struct select_npy_type<int64_t> { const static NPY_TYPES type = NPY_int64; };
...
// template <> struct select_npy_type<unsigned long long> { const static NPY_TYPES type = NPY_int64; };
...
// {
//     assert(type == NPY_int8 || type == NPY_FLOAT);
...
// {
//     detail::imshow((void *) ptr, NPY_int8, rows, columns, colors, keywords, out);
// }
